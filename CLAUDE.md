...
`test_object_measurement.py` covers `obejct_measurement.py`, etc.), 165 tests as of 2026-09-03.
`test_qc_figures.py` is still being built out (50 of a planned ~55 tests — `TestPanelECFD`,
`TestPanelSpotmap` and the 3 figure-builder classes are still empty `pass` stubs; see `todo.txt`
