...
class ModelBundle:
    ...
    def _load_cellpose(config: dict) -> models.CellposeModel:
        ...
        return models.CellposeModel(gpu=True, pretrained_model=str(config["paths"]["cellpose_models_path"]))
    ...
    def _load_spotiflow_from_config(config: dict, do_3d: bool) -> Spotiflow:
        ...
        try:
            ...
            print(f"  Loaded custom Spotiflow model from: {config['paths']['spotiflow_models_path']}")
            return model
