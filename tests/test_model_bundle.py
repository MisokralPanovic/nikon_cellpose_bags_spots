...
class TestLoadCellpose:
    ...
    def test_calls_cellpose_models_with_correct_path(self, mocker: MockerFixture, base_config):
...
class TestLoadSpotiflow:
    ...
    def test_loads_custom_model_successfully(self, mocker: MockerFixture, base_config):
        ...
        mocker.patch.object(ModelBundle, "_validate_spotiflow_mode", return_value=mock_model)
    ...
    def test_falls_back_to_pretrained_2d_when_custom_load_fails(self, mocker: MockerFixture, base_config):
        mocker.patch(
    ...
    def test_falls_back_to_pretrained_3d_when_custom_load_fails(self, mocker: MockerFixture, base_config):
        mocker.patch(
            "spot_detector.utils.Spotiflow.from_folder",
            side_effect=Exception("not found")
        )
...
class TestValidateSpotiflowMode:
    ...
    def test_overrides_with_pretrained_when_mode_mismatches_2d_pipeline(self, mocker: MockerFixture):
        mock_model = mocker.MagicMock()
    ...
    def test_overrides_with_pretrained_when_mode_mismatches_3d_pipeline(self, mocker: MockerFixture):
        mock_model = mocker.MagicMock()
...
class TestModelBundleLoad:
    ...
    def test_load_returns_bundle_with_both_models(self, mocker: MockerFixture, base_config):
